...
const Header: React.FC = () => {
  ...
  return (
    <header className="w-full sticky top-0 z-10 bg-white bg-opacity-30 backdrop-blur-md border-b border-white border-opacity-20 shadow-lg animate-fade">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex justify-center items-center animate-pulse">
            <a
              className="text-slate-900 text-center font-semibold text-xs uppercase tracking-wider cursor-pointer"
              href="https://maps.app.goo.gl/5Uw55X2pDde3jtCK9"
              target="_blank"
          ...
          smooth={true}
          duration={500}
          className="px-6 py-2 text-white/90 rounded-lg text-lg font-medium bg-[#017374] hover:bg-[#017374]/80 duration-300 mb-2 cursor-pointer"
          onClick={toggleMenu}
        >
          Envíos
        </ScrollLink>
      ...
      >
        <a
          className="text-slate-900 max-w-48 text-center font-semibold text-[9px] uppercase tracking-wider animate-pulse cursor-pointer mb-2"
          href="https://maps.app.goo.gl/5Uw55X2pDde3jtCK9"
          target="_blank"
          rel="noopener noreferrer"
        >
